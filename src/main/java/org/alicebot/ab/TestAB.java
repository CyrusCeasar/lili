...
public class TestAB {
    ...
    public static void testChat (Bot bot, boolean doWrites, boolean traceMode) {
        ...
        while (true) {
            ...
            else if (textLine.equals("sc")) sraixCache("c:/org.alicebot.ab/data/sraixdata6.txt", chatSession);
            ...
            else if (textLine.equals("org/alicebot/ab")) testAB(bot, sample_file);
            else {
    ...
    public static void runTests(Bot bot, boolean traceMode) {
        ...
        //        bot.preProcessor.normalizeFile("c:/org.alicebot.ab/bots/super/aiml/thats.txt", "c:/org.alicebot.ab/bots/super/aiml/normalthats.txt");
        bot.brain.nodeStats();
        MagicBooleans.trace_mode = traceMode;
