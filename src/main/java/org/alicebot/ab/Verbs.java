...
public class Verbs {
    ...
    static Set<String> bing = Utilities.stringSet("org/alicebot/ab","at","op","el","in","ur","op","er","un","in","it","et","ut","im","id","ol","ig");
    ...
    public static void getIrregulars() {
        ...
        String irrFile = Utilities.getFile("c:/org.alicebot.ab/data/irrverbs.txt");
    ...
    public static void makeVerbSetsMaps (Bot bot) {
        getIrregulars();
        String verbFile = Utilities.getFile("c:/org.alicebot.ab/data/verb300.txt");
